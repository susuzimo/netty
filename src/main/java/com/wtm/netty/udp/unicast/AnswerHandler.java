package com.wtm.netty.udp.unicast;
...
public class AnswerHandler extends
    ...
    protected void channelRead0(ChannelHandlerContext ctx, DatagramPacket packet) throws Exception {
        ...
        if(UdpQuestionSide.QUESTION.equals(req)){
             ...
             * 重新发送出去！
             */
            ctx.writeAndFlush(new DatagramPacket(Unpooled.copiedBuffer(UdpAnswerSide.ANSWER+nextQuote(), CharsetUtil.UTF_8), packet.sender()));
        }
    }
    @Override
